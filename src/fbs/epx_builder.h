...
#define __epx_command_formal_args , uint8_t v0, epx_span_t *v1, epx_io_t_enum_t v2, flatbuffers_uint8_vec_ref_t v3
...
__flatbuffers_build_struct_field(1, flatbuffers_, epx_command_span, epx_span, 16, 8, epx_command)
